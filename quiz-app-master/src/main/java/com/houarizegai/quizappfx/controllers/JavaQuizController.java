...
public class JavaQuizController implements Initializable {
    ...
    private void redirect() {
        ...
        switch (choix) {
            case 1: {
                titleLbl.setText("Базовый");
            }
            break;
            case 2: {
                titleLbl.setText("Операторы");
            }
            break;
            case 3: {
                titleLbl.setText("Циклы");
            }
            break;
            case 4: {
                titleLbl.setText("ООП");
            }
            break;
            case 5: {
                titleLbl.setText("Полиморфизм");
            }
            break;
            case 6: {
                titleLbl.setText("Исключение");
            }
            break;
            case 7: {
                titleLbl.setText("Продвинутый");
            }
            break;
        }
